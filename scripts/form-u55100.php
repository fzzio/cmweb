...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nombre:</b></td><td>' . htmlentities($_REQUEST["custom_U55111"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Mensaje:</b></td><td>' . htmlentities($_REQUEST["custom_U55139"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>A medida:</b></td><td>' . htmlentities($_REQUEST["custom_U55101"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>A medida:</b></td><td>' . htmlentities($_REQUEST["custom_U55117"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>A medida:</b></td><td>' . htmlentities($_REQUEST["custom_U55122"],ENT_COMPAT,'UTF-8') . '</td></tr>';
