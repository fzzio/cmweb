<?php
  ...
  try {
    $sqlImagen = "
      SELECT *
      FROM servicio
      WHERE estado = '1' and titulo = 'Mobile Marketing'";
    ...
    $sqlPro = "
      ...
      WHERE p.estado = '1' and p.prioridad = '1' and titulo = 'Mobile Marketing' and p.id_servicio=s.id";
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="clip_frame clearfix mse_pre_init" id="u49712"><!-- image -->
     <div id="u49712_clip">
      <img class="position_content" id="u49712_img" src="images/<?php echo $servicios[0]['imagen']; ?>" alt="" width="525" height="525"/>
     </div>
    </div>
    ...
    <div class="clearfix colelem" id="ppu46615-4"><!-- group -->
     ...
     <div class="clearfix grpelem" id="ppu49729"><!-- column -->
      ...
      <div class="colelem" id="u50490"><img src="images/<?php echo $proyectos[0]['imagen'];?>" alt="" width="350" height="145"/></div> <!-- width="350" height="50" -->
     </div>
    </div>
