  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="clip_frame clearfix mse_pre_init" id="u49768"><!-- image -->
     <div id="u49768_clip">
      <img class="position_content" id="u49768_img" src="images/<?php echo $servicios[0]['imagen']; ?>" alt="" width="525" height="525"/>
     </div>
    </div>
    ...
    <div class="clearfix colelem" id="ppu49789-7"><!-- group -->
     ...
     <div class="clearfix grpelem" id="pu50495"><!-- column -->
      <div class="colelem" id="u50495"><img src="images/<?php echo $proyectos[0]['imagen'];?>" alt="" width="350" height="145"/></div>
