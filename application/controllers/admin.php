...
class Admin extends CI_Controller {
    ...
    public function adminServicios(){
        ...
        $crud->display_as('icono','Imagen Icono');
        $crud->display_as('color','Color');
        $crud->display_as('estado','Estado');

        $crud->required_fields('titulo','subtitulo', 'descripcion', 'imagen', 'icono', 'color', 'estado');
        $crud->columns('titulo','subtitulo', 'descripcion', 'imagen', 'icono', 'color', 'estado');
        $crud->set_field_upload('imagen', 'assets/celmediachile/servicios');
        $crud->set_field_upload('icono', 'assets/celmediachile/servicios');
        $crud->fields('titulo','subtitulo', 'descripcion', 'imagen', 'icono', 'color', 'estado');
