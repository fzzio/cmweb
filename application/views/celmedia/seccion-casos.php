		...
		<div class="container">
			...
			<div class="row espaciado-a">
				<?php foreach ($proyectos as $proyecto): ?>
					<a href="<?php echo site_url('site/proyecto') . '/' . $proyecto['prid'];?>" class="link-media">
			...
			<div class="row espaciado-a">
				<div class="col-md-4 col-md-offset-8 col-sm-5 col-sm-offset-7 text-center page-scroll">
					<a href="<?php echo site_url('site/proyecto'); ?>" class="btn btn-slh link-home">Ver todos los casos</a>
				</div>
			</div>
